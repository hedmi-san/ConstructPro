...
public class HomePage extends JPanel {
    ...
    private void initComponents() {
        ...
        label2.setText("<html>"
                ...
                + "<li><b>Salary:</b> Permet de suivre les jours de présence de chaque travailleur pour le calcul des salaires</li>"
                ...
                + "<li><b>Camion:</b> Contient les informations sur les véhicules de l’entreprise, comme les camions et engins</li>"
